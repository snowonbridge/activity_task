...
class Redis{
    ...
    public  $oRedis = null; //当前的redis连接对象
    ...
    private function getSet($key,$val)
    {
        $r = $this->oRedis->getSet($key,$val);
        return $r;
    }
    ...
    private   function close() {
        Logger::write("关闭redis连接",__METHOD__,"WARNGING");
        $this->oRedis && $this->oRedis->close();
