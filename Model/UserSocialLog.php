...
class UserSocialLog extends Model{
    ...
    {
        $add_time = $add_time?$add_time:date('Ymd',time());
        $r = ATCode::getCache(Okey::UserSocialLog($uid,$activity_id,$add_time),function($uid,$activity_id,$add_time){
    ...
    {
        $add_time = $add_time?$add_time:date('Ymd',time());
        return ATCode::getCache(Okey::UserSocialLog($uid,$activity_id,$add_time),function($uid,$activity_id,$add_time){
            $result = $this->getRow($this->table,'uid=:uid and activity_id=:activity_id and add_time=:add_time order by create_time desc',[
                ':uid'=>$uid,':activity_id'=>$activity_id,':add_time'=>$add_time]);
    ...
    {
        return ATCode::rmCache(Okey::UserSocialLog($uid,$activity_id,$add_time));
    }
} 